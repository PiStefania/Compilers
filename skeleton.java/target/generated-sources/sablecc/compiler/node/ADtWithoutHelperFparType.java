...
public final class ADtWithoutHelperFparType extends PFparType
{
    private PDataType _dataType_;

    public ADtWithoutHelperFparType()
    {
        // Constructor
    }
    ...
    public Object clone()
    {
        return new ADtWithoutHelperFparType(
            cloneNode(this._dataType_));
    }

    public void apply(Switch sw)
    {
        ((Analysis) sw).caseADtWithoutHelperFparType(this);
    }
